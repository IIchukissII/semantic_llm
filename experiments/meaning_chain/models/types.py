...
class SemanticProperties:
    """Semantic properties of a concept in 16D space."""
    g: float = 0.0                    # Goodness (projection onto j_good)
    tau: float = 3.0                  # Abstraction level [1=abstract, 6=concrete]
...
class MeaningNode:
    ...
    - Its semantic properties (g, tau, j-vector)
    ...
    def __repr__(self) -> str:
        ...
        return f"MeaningNode({self.word}{verb_str}, g={self.g:.2f}, τ={self.tau:.1f}{children_str})"
...
class MeaningTree:
    ...
    def summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'avg_goodness': np.mean([n.g for n in all_nodes]) if all_nodes else 0,
    ...
    def pretty_print(self, indent: str = "  ") -> str:
        ...
        def print_node(node: MeaningNode, prefix: str = "", is_last: bool = True):
            ...
            lines.append(f"{prefix}{connector}{verb_str}{node.word} [g={node.g:.2f}, τ={node.tau:.1f}]")
